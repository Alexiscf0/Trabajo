...
public class Index extends JFrame {
	...
	public Index(ConexionMySQL conexion) {
		...
		JLabel lbl_titulo = new JLabel("KOKO");
		...
		JTextArea txtrPlDeLa = new JTextArea();
		txtrPlDeLa.setText("Pl. de encarnación");
		txtrPlDeLa.setBounds(106, 55, 144, 25);
		contentPane.add(txtrPlDeLa);
		...
		JTextArea txtrDiscoteca = new JTextArea();
		txtrDiscoteca.setText("Discoteca");
		txtrDiscoteca.setBounds(106, 92, 144, 25);
		contentPane.add(txtrDiscoteca);
		...
		textArea_Valo.setText("10");
		textArea_Valo.setBounds(106, 129, 144, 25);
		contentPane.add(textArea_Valo);
		
		JLabel lblNewLabel = new JLabel("New label");
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\alexi\\Desktop\\img_app\\photo-1618005182384-a83a8bd57fbe.jpeg"));
		lblNewLabel.setBounds(-21, 0, 457, 263);
		...
		if (datosRestaurante != null) {
			...
			txtrPlDeLa.setText(datosRestaurante.getUbicacion());
			txtrDiscoteca.setText(datosRestaurante.getTipo());
		...
		if (datosDiscoteca != null) {
			...
			txtrPlDeLa.setText(datosDiscoteca.getUbicacion());
			txtrDiscoteca.setText(datosDiscoteca.getTipo());
		...
		if (datosCafeteria != null) {
			...
			txtrPlDeLa.setText(datosCafeteria.getUbicacion());
			txtrDiscoteca.setText(datosCafeteria.getTipo());
