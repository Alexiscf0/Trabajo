	...
	public Valoracion(ConexionMySQL conexion) {
		...
		btn_Valoracion.addActionListener(e -> {
			...
			if (IniciarSesion.SesionIniciada == false) {
				...
				//boolean nuevaValoracion = conexion.setNuevaValoracion(IniciarSesion.nombreUsuario, nombreLocal, valoracion);
			}
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\alexi\\Desktop\\img_app\\73246568-imagen-de-representación-3d-de-calidad-de-estrella-de-oro-de-5-estrellas.jpg"));
		lblNewLabel.setBounds(-11, 0, 836, 594);
